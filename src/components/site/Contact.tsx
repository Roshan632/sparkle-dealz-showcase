...
export function Contact() {
  return (
    <section id="contact" className="relative overflow-hidden py-24 md:py-32">
      <div className="absolute inset-0 -z-10 bg-linear-to-b from-background via-secondary/30 to-background" />
      <div
        className="absolute left-1/2 top-0 -z-10 h-150 w-200 -translate-x-1/2 rounded-full opacity-40 blur-[120px]"
      ...
      <div className="mx-auto max-w-5xl px-6 text-center">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          ...
          >
            <Phone className="h-4 w-4" /> +977 9804973436
          </a>
        </div>
